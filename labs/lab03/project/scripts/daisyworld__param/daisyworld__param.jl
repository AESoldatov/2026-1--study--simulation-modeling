...
for params in params_list
	...
	hash_part = bytes2hex(sha256(string(params)))[1:8]

	plt1_name = "daisyworld_$(hash_part)_step01.png"
	plt2_name = "daisyworld_$(hash_part)_step04.png"
	plt3_name = "daisyworld_$(hash_part)_step40.png"
